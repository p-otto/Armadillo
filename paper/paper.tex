...
Figure~\ref{fig:system_diagram} shows the architecture of our design.

\begin{figure}
    \begin{center}
        \includegraphics[width=200px]{fig/system_diagram.eps}
    \end{center}
    \caption{The architecture of our design.} \label{fig:system_diagram}
\end{figure}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=200px]{fig/initialization.eps}
    \end{center}
    \caption{An initialization process.} \label{fig:initialization}
\end{figure}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=200px]{fig/instance_creation.eps}
    \end{center}
    \caption{An initialization process.} \label{fig:instance_creation}
\end{figure}
...
\begin{figure}
    \begin{center}
        \includegraphics[width=200px]{fig/event_sending.eps}
    \end{center}
    \caption{An initialization process.} \label{fig:event_sending}
\end{figure}
...
we chose mapping approach
other approaches part of further work, e.g. token based
