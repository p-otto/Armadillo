...
The implementation can be found at \url{https://github.com/p-otto/armadillo}, in the \texttt{armadillo} and \texttt{eth\_admin} folders, respectively.
...
A screencast of the full choreography can be found in the respository under \url{https://github.com/p-otto/armadillo/blob/master/presentation/armadillo-screencast.mp4}.
% TODO repo, hbox etc.
