...
Our goal is to decrease the amount of trust needed between the communication partners.
...
Building upon the BPMN viewer provided in the toolkit, we implemented the handling of user clicks on tasks, which allowed us to use the viewer as a process engine mock.
...
\paragraph{Process Engine Integration}
