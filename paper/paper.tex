...
An example can be seen in Figure \ref{collaborationexample}. % TODO reference example here
...
Caterpillar~\cite{lopez2017caterpillar} is an implementation of a process engine using smart contracts, handling the most common BPMN elements.
