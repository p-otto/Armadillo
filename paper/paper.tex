...
\section{Appendix}
% TODO highlight different parts as described in section Implementation? or remove?
\begin{lstlisting}[
...
contract BulkBuyer {
    ...
    function receiveStartOfProduction(address sender) 
      public manufacturerAuthorized(sender, "receiveStartOfProduction")
    {
        emit StartOfProductionReceived();
    }

    function receiveProduct(address sender) 
      public manufacturerAuthorized(sender, "receiveProduct")
    {
